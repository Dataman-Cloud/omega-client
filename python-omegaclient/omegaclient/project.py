...
class ProjectAPI(OmegaClient):
    ...
    def get_project(self, project_id):
        ...
        return self.http.get(url_maker(self.prefix, project_id))
    ...
    def create_project(self, **kwargs):
        ...
        return self.http.post(self.prefix, data=kwargs)
    ...
    def update_project(self, project_id, **kwargs):
        ...
        return self.http.patch(url_maker(self.prefix, project_id), data=kwargs)

    def delete_project(self, project_id):
        """Delete specified project."""

        return self.http.delete(url_maker(self.prefix, project_id))

    def get_project_builds(self, project_id):
        """list all builds for project"""

        return self.http.get(url_maker(self.prefix, project_id, "builds"))
